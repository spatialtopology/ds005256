...
$(dirname "$0")/rename_file "${DUPJSON}" "${RENAMEJSON}"
...
# Original and new JSON filenames
DUPJSON="./sub-0057/ses-01/fmap/sub-0057_ses-01_acq-mb8_dir-pa_run-02_epi__dup-01.json"
RENAMEJSON="./sub-0057/ses-01/fmap/sub-0057_ses-01_acq-mb8_dir-pa_run-03_epi.json"
